...
var setcolor = 0x0AC878;
//var setcolor = 0xF2F111;
//var setcolor = 0xFF6347;

scene.background = new THREE.Color(setcolor);
scene.fog = new THREE.Fog(setcolor, 28, 72);
...
function init() {
  ...
  var gmaterial = new THREE.MeshToonMaterial({color:0xC8FF5A, side:THREE.DoubleSide});
...
//----------------------------------------------------------------- GRID Helper
var gridHelper = new THREE.GridHelper( 60, 120, 0x0AC878, 0x062318);
city.add( gridHelper );
...
var createCars = function(cScale = 2, cPos = 20, cColor = 0xC8FF5A) {
